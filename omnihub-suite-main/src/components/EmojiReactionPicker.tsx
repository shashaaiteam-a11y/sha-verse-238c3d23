    ...
    <>
      ...
      <Dialog open={showPicker} onOpenChange={setShowPicker}>
        <DialogContent className="w-[95vw] max-w-[95vw] sm:max-w-2xl lg:max-w-4xl h-[65vh] sm:h-[75vh] lg:h-[85vh] p-0 rounded-xl overflow-hidden flex flex-col">
          <DialogHeader className="p-3 sm:p-4 pb-2 border-b flex-shrink-0 bg-card z-10 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-full hover:bg-secondary/80 transition-all duration-200 p-1.5 -mr-2 opacity-70 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
          ...
          <div className="p-2 sm:p-3 border-t bg-muted/30 flex-shrink-0">
            <p className="text-[10px] sm:text-xs text-muted-foreground text-center">
              ✨ Click emoji to react • [X] to close • Click again to change your reaction
            </p>
          </div>
        </DialogContent>
      </Dialog>
