...
import ChatMediaAttachment from './chat/ChatMediaAttachment';
              ...
              pinnedMessages.length > 0 ? (() => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-muted/80 backdrop-blur border-b border-border cursor-pointer hover:bg-muted"
                  >
