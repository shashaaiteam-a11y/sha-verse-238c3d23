...
const Privacy = () => (
  <>
    ...
    <LegalPageLayout title="Privacy Policy" updated="May 2, 2026">
      ...
      <h2>3. Advertising</h2>
      <p>
        We use <strong>Mediation setup</strong> on our mobile app and website. These services may use cookies,
        advertising IDs, and similar identifiers to serve personalized ads.
      </p>
      ...
      <p>
        ...
        personal data to third parties. However, we may share limited data with trusted partners (such as advertising
        and analytics providers) to operate and improve our services.
      </p>
      ...
      <p>
        We ensure appropriate technical and legal safeguards are in place to protect your data during such transfers.
      </p>
      ...
      <h2>13. Consent</h2>
      <p>
        By using Sha-Verse, you consent to the collection and use of your information as described in this Privacy
        Policy.
      </p>
      ...
      <h2>15. Child Safety Standards (CSAE & CSAM Policy)</h2>

      <p>
        Sha-Verse is committed to maintaining a safe environment for all users and has a strict zero-tolerance policy
        toward Child Sexual Abuse and Exploitation (CSAE) and Child Sexual Abuse Material (CSAM).
      </p>

      <p>
        Any content, communication, profile, group, page, post, comment, image, video, live stream, message, book,
        story, or other material that depicts, promotes, encourages, requests, distributes, or facilitates child sexual
        abuse or exploitation is strictly prohibited on Sha-Verse.
      </p>

      <ul>
        <li>
          Users may not upload, publish, transmit, share, store, request, promote, or distribute Child Sexual Abuse
          Material (CSAM) in any form.
        </li>

        <li>
          Any attempt to exploit, groom, threaten, harass, sexually solicit, endanger, or otherwise abuse a minor is
          strictly prohibited.
        </li>

        <li>
          Sha-Verse provides in-app safety tools that allow users to report accounts, chats, posts, comments, stories,
          videos, books, groups, profiles, or any other content that may violate these standards.
        </li>

        <li>Users can also block individuals who engage in abusive, illegal, or harmful behavior.</li>

        <li>
          Reports involving potential child exploitation are reviewed as quickly as reasonably possible by our
          moderation team.
        </li>

        <li>Content that violates these standards may be removed immediately without prior notice.</li>

        <li>Accounts involved in CSAE or CSAM activities may be permanently suspended or terminated.</li>

        <li>
          Where required by applicable laws, Sha-Verse will cooperate with law enforcement agencies, child protection
          organizations, and relevant government authorities by reporting confirmed illegal content and responding to
          lawful requests.
        </li>

        <li>
          Sha-Verse continuously improves its moderation systems, automated detection technologies, reporting
          mechanisms, and safety practices to help identify and prevent child exploitation on the platform.
        </li>

        <li>
          False reports submitted maliciously may also result in enforcement actions against the reporting account.
        </li>
      </ul>

      <p>
        If you encounter content or behavior that may involve child sexual abuse, exploitation, or child endangerment,
        please report it immediately using the in-app reporting tools or contact our Child Safety Team.
      </p>

      <p>
        <strong>Child Safety Contact</strong>
        <br />
        Email: <a href="mailto:shashaaiteam@gmail.com">shashaaiteam@gmail.com</a>
      </p>

      <p>
        By using Sha-Verse, you agree to comply with these Child Safety Standards. Violations may result in immediate
        removal of content, permanent account suspension, account termination, and referral to appropriate authorities
