  ...
  async function handleDownloadData() {
    ...
    try {
      const [profileRes, postsRes, friendsRes, savedRes] = await Promise.all([
        supabase.from('profiles').select('id, username, display_name, bio, avatar_url, cover_url, location, website, created_at, updated_at, work, education, facebook_url, instagram_url, twitter_url, hobbies, about_me, privacy, provider, last_login, is_verified, is_deactivated, deactivated_at').eq('id', user.id).single(),
